...
public class HomeController {
    ...
    public String about(Model model) {
        ...
        model.addAttribute("author", "Developed by: Santiago Henao");
        return "home/about";
    }
    ...
    public String contact(Model model) {
        ...
        model.addAttribute("subtitle", "Get in Touch");
        model.addAttribute("email", "contact@onlinestore.com");
        model.addAttribute("address", "123 Fake Street, City, Country");
        model.addAttribute("phone", "+1 234 567 890");
        return "home/contact";
    }
